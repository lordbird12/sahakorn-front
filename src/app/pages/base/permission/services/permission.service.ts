...
export class PermissionService {
  ...
  update(permissionId: number, permission: Permission): Observable<Permission> {
    return this.http
      .patch<Permission>(`${environment.API_URL}/api/permission/${permissionId}`, permission, this.httpOptions)
      .pipe(catchError(this.handlerError));
  }
